...
/**
 * The time plane publishes intelligence triggers and consumes nothing — its work arrives by
...
class KafkaConfigTest {
    ...
    void declaresNoConsumerOrInboundTopic() {
        ...
        assertFalse(beanMethods.contains("kafkaListenerContainerFactory"),
                "this service consumes no topic — a listener container here would be dead wiring");
