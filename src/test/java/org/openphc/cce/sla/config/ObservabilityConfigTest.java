...
class ObservabilityConfigTest {
    ...
    void registersTheEvaluatorBacklogGauge() {
        ...
        MeterBinder binder = new ObservabilityConfig().slaMetrics(repository, onTimeRepository);
    ...
    void gaugeTracksTheRepositoryRatherThanASnapshot() {
        ...
        SimpleMeterRegistry registry = new SimpleMeterRegistry();
        new ObservabilityConfig().slaMetrics(repository, onTimeRepository).bindTo(registry);
