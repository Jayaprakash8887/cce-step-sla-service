...
schedule to do it. It writes `step_instance.sla_status` — it is the column's only writer.
...
```bash
./gradlew test              # 46 tests (44 unit + 2 context-boot tests)
